...
def get_kpi_cards():
    try:
        ...
        json_path = 'OPTIMAS_Demo_JSONs\kpi_cards.json'
...
def get_overall_performance_donut_chart():
    try:
        # Define the JSON file path (use relative path)
        json_path = 'OPTIMAS_Demo_JSONs\overall_performance_donut_chart.json'
...
def get_apparel_performance_top_10_stacked_column__chart():
    try:
        # Define the JSON file path (use relative path)
        json_path = 'OPTIMAS_Demo_JSONs\item_type_group_performance.json'
...
def get_apparel_group_performance_top_10_horizontal_stacked_bar_chart():
    try:
        ...
        # Define the JSON file path (use relative path)
        json_path = 'OPTIMAS_Demo_JSONs\item_attribute_performance.json'
...
def get_item_type_performance_top_10_stacked_horizontal_bar_chart():
    try:
        # Define the JSON file path (use relative path)
        json_path = 'OPTIMAS_Demo_JSONs\item_type_performance.json'
...
def get_cumulative_performance_stacked_area_chart():
    try:
        # Define the JSON file path (use relative path)
        json_path = 'OPTIMAS_Demo_JSONs\cumulative_performance_stacked_area_chart.json'
